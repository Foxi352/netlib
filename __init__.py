...
class CLIHandler(object):
    ...
    def __init__(self, smarthome, client, source, updates, hashed_password, commands):
        """
        Constructor
...
class CLI(SmartPlugin):
    ...
    def __init__(self, smarthome, update='False', ip='::1', port=2323, hashed_password=''):
        """
        Constructor
        :param smarthome: smarthomeNG instance
        ...
        ip='::'
        self.server = Network.tcp_server(interface=ip, port=port)
        self.server.name = 'CLI'
